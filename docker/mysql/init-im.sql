...
CREATE TABLE IF NOT EXISTS `group_apply` (
  ...
  `handler_id` bigint unsigned DEFAULT NULL COMMENT '处理人ID（群主或管理员）',
  `create_time` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '申请时间',
...
CREATE TABLE IF NOT EXISTS `group_member` (
  ...
  `extra` varchar(1000) DEFAULT NULL COMMENT '扩展字段(背景图、备注等)',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='号段表';
