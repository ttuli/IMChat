...
const file_pkg_proto_message_message_proto_rawDesc = "" +
	"\n" +
	"\x1fpkg/proto/message/message.proto\x12\amessage\x1a\x1bpkg/proto/group/group.proto\"\x8e\x03\n" +
	...
	"\tsend_time\x18\a \x01(\x03R\bsendTime\x12\x1b\n" +
	"\amsg_seq\x18\b \x01(\x04B\x020\x01R\x06msgSeq\x12.\n" +
	...
	"sessionKey\x12*\n" +
	"\x06status\x18\x04 \x01(\x0e2\x12.message.AckStatusR\x06status\"\xff\x01\n" +
	"\n" +
	"PersistAck\x12\x15\n" +
	"\x06msg_id\x18\x01 \x01(\tR\x05msgId\x12\x1b\n" +
	"\tclient_id\x18\x02 \x01(\tR\bclientId\x12\x1d\n" +
	...
	"\x03seq\x18\a \x01(\x04B\x020\x01R\x03seq\x12\x1f\n" +
	...
	"\tread_time\x18\x04 \x01(\x03R\breadTime\"\x80\x01\n" +
	"\rMessageRecall\x12\x15\n" +
	"\x06msg_id\x18\x01 \x01(\tR\x05msgId\x12\x1f\n" +
	"\vrecall_time\x18\x04 \x01(\x03R\n" +
	"recallTime\x12\x16\n" +
	"\x06reason\x18\x05 \x01(\tR\x06reasonJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04R\auser_idR\n" +
	"session_id\"\x9b\x03\n" +
	"\aSession\x12\x1d\n" +
	"\n" +
	...
	"\vsession_key\x18\x03 \x01(\tR\n" +
	"sessionKey\x12!\n" +
	"\flast_content\x18\x04 \x01(\tR\vlastContent\x12\x1b\n" +
	"\amax_seq\x18\x05 \x01(\x03B\x020\x01R\x06maxSeq\x12\x1f\n" +
	...
	"\bgroup_id\x18\x01 \x01(\x04R\agroupId\x124\n" +
	"\aop_type\x18\x02 \x01(\x0e2\x1b.message.GroupOperationTypeR\x06opType\x12\x1f\n" +
	...
	"\n" +
	"group_info\x18\a \x01(\v2\x12.grouppb.GroupInfoR\tgroupInfoJ\x04\b\b\x10\tJ\x04\b\t\x10\n" +
	"R\x06msg_idR\n" +
	"session_id\"\xeb\x01\n" +
	"\rNotifyMessage\x12(\n" +
	"\x04base\x18\x01 \x01(\v2\x14.message.BaseMessageR\x04base\x12?\n" +
	"\fgroup_notify\x18\x02 \x01(\v2\x1a.message.GroupNotificationH\x00R\vgroupNotify\x120\n" +
	"\x06recall\x18\x03 \x01(\v2\x16.message.MessageRecallH\x00R\x06recall\x125\n" +
	"\x06system\x18\x04 \x01(\v2\x1b.message.SystemNotificationH\x00R\x06systemB\x06\n" +
	"\x04body*\xd3\x01\n" +
	...
	"\x15MESSAGE_STATUS_FAILED\x10\x06*\xd1\x02\n" +
	...
	"\x1aMESSAGE_EXTRA_KEY_DURATION\x10\x14\x12$\n" +
	" MESSAGE_EXTRA_KEY_NOTIFY_PAYLOAD\x10\x1e*T\n" +
	"\tAckStatus\x12\x16\n" +
	...
	"\x1aNOTIFICATION_TYPE_SECURITY\x10\x03*\x90\x02\n" +
	...
	"B\x17Z\x15IM2/pkg/proto/messageb\x06proto3"
