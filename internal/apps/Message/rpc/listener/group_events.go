...
func (l *NatsListener) handleGroupEvent(ctx context.Context, sessionID string, notify *message.GroupNotification) {
...
// 由读路径回源构建全量数据）。所有操作幂等。
func (l *NatsListener) syncGroupRoute(ctx context.Context, notify *message.GroupNotification) {
