...
const file_rpc_message_proto_rawDesc = "" +
	...
	"updateTime\x12!\n" +
	"\funread_count\x18\b \x01(\x04R\vunreadCount\"z\n" +
	...
	"\bsessions\x18\x01 \x03(\v2\x17.messagerpc.UserSessionR\bsessions\"\xa1\x01\n" +
	...
	"\n" +
	"is_disturb\x18\x05 \x01(\x05R\tisDisturb\"\x13\n" +
	...
	"\bsessions\x18\x01 \x03(\v2\x13.messagerpc.SessionR\bsessions\"g\n" +
	"\x12MarkSessionReadReq\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12\x1d\n" +
	"\n" +
	"session_id\x18\x02 \x01(\tR\tsessionId\x12\x19\n" +
	"\bread_seq\x18\x03 \x01(\x04R\areadSeq\"\x15\n" +
	"\x13MarkSessionReadResp\"r\n" +
	...
	"\asession\x18\x01 \x01(\v2\x13.messagerpc.SessionR\asession2\xf2\x03\n" +
	"\n" +
	"MessageRpc\x12C\n" +
	"\n" +
	...
	"\x15GetUserActiveSessions\x12$.messagerpc.GetUserActiveSessionsReq\x1a%.messagerpc.GetUserActiveSessionsResp\x12R\n" +
	"\x0fMarkSessionRead\x12\x1e.messagerpc.MarkSessionReadReq\x1a\x1f.messagerpc.MarkSessionReadResp\x12C\n" +
	"\n" +
