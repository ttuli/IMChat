...
const file_internal_apps_Message_api_types_message_api_proto_rawDesc = "" +
	"\n" +
	"1internal/apps/Message/api/types/message_api.proto\x12\x05types\"\xb5\x02\n" +
	"\aMessage\x12\x15\n" +
	...
	"\x03seq\x18\x06 \x01(\x04B\x020\x01R\x03seq\x12\x18\n" +
	...
	"sessionKey\x12\x1b\n" +
	"\amax_seq\x18\x04 \x01(\x04B\x020\x01R\x06maxSeq\x12!\n" +
	"\n" +
	"actual_seq\x18\x05 \x01(\x04B\x020\x01R\tactualSeq\x12!\n" +
	...
	"\rlast_read_seq\x18\x05 \x01(\x04B\x020\x01R\vlastReadSeq\x12\x1f\n" +
	"\vcreate_time\x18\x06 \x01(\x03R\n" +
	"createTime\x12\x1f\n" +
	"\vupdate_time\x18\b \x01(\x03R\n" +
	"updateTime\x12!\n" +
	"\funread_count\x18\t \x01(\x04R\vunreadCount\"\x82\x01\n" +
	"\rGetHistoryReq\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x1f\n" +
	"\tstart_seq\x18\x02 \x01(\x03B\x020\x01R\bstartSeq\x12\x1b\n" +
	"\aend_seq\x18\x03 \x01(\x03B\x020\x01R\x06endSeq\x12\x14\n" +
	"\x05limit\x18\x04 \x01(\x05R\x05limit\"4\n" +
	"\x0eGetHistoryResp\x12\"\n" +
	"\x04list\x18\x01 \x03(\v2\x0e.types.MessageR\x04list\"\x88\x01\n" +
	...
	"\x06is_top\x18\x03 \x01(\x05R\x05isTop\x12\x1d\n" +
	"\n" +
	"is_disturb\x18\x04 \x01(\x05R\tisDisturb\"E\n" +
	...
	"\x12MarkSessionReadReq\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x1d\n" +
	"\bread_seq\x18\x02 \x01(\x04B\x020\x01R\areadSeq\"H\n" +
