...
func (GroupOperationType) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[6].Descriptor()
}

func (GroupOperationType) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[6]
}
...
func (ConversationType) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[7].Descriptor()
}

func (ConversationType) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[7]
}
...
func (NotificationType) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[8].Descriptor()
}

func (NotificationType) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[8]
}
...
func (ApplyStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[9].Descriptor()
}

func (ApplyStatus) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[9]
}
...
func (ApplySource) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[10].Descriptor()
}

func (ApplySource) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[10]
}
...
func (Gender) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[11].Descriptor()
}

func (Gender) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[11]
}
...
func (JoinType) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[12].Descriptor()
}

func (JoinType) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[12]
}
...
func (UserStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[13].Descriptor()
}

func (UserStatus) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[13]
}
...
func (ErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_type_proto_enumTypes[14].Descriptor()
}

func (ErrorCode) Type() protoreflect.EnumType {
	return &file_type_proto_enumTypes[14]
}
...
type WSMessage struct {
	...
	Type          MessageType            `protobuf:"varint,2,opt,name=type,proto3,enum=types.MessageType" json:"type,omitempty"` // 消息类型
	Payload       []byte                 `protobuf:"bytes,3,opt,name=payload,proto3" json:"payload,omitempty"`                   // 具体消息内容(根据type解析)
	Version       int32                  `protobuf:"varint,4,opt,name=version,proto3" json:"version,omitempty"`                  // 协议版本号
...
func (x *InternalMessage) GetInternalExt() map[string]string {
	if x != nil {
...
type BaseMessage struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MsgId         string                 `protobuf:"bytes,1,opt,name=msg_id,json=msgId,proto3" json:"msg_id,omitempty"`                                                           // 消息ID (message.proto: int64 msgId)
	...
	FromUserId    uint64                 `protobuf:"varint,4,opt,name=from_user_id,json=fromUserId,proto3" json:"from_user_id,omitempty"`                                         // 发送者ID (message.proto: uint64 fromId)
	ToUserId      uint64                 `protobuf:"varint,5,opt,name=to_user_id,json=toUserId,proto3" json:"to_user_id,omitempty"`                                               // 接收者ID (message.proto: uint64 toId)
	GroupId       uint64                 `protobuf:"varint,6,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`                                                    // 群组ID (message.proto: uint64 toId when ChatType=GROUP)
	...
	Status        MessageStatus          `protobuf:"varint,9,opt,name=status,proto3,enum=types.MessageStatus" json:"status,omitempty"`                                            // 消息状态
...
func (x *BaseMessage) GetToUserId() uint64 {
	if x != nil {
		return x.ToUserId
	}
	return 0
...
func (x *BaseMessage) GetGroupId() uint64 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
type MessageAck struct {
	...
	ClientId      string                 `protobuf:"bytes,2,opt,name=client_id,json=clientId,proto3" json:"client_id,omitempty"`    // 客户端ID
	SessionId     string                 `protobuf:"bytes,3,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"` // 会话ID
	Status        AckStatus              `protobuf:"varint,4,opt,name=status,proto3,enum=types.AckStatus" json:"status,omitempty"`  // 确认状态
...
type UserOnlineStatus struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	UserId         uint64                 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                           // 用户ID
	Status         OnlineStatus           `protobuf:"varint,2,opt,name=status,proto3,enum=types.OnlineStatus" json:"status,omitempty"`                 // 在线状态
...
type GroupMember struct {
	...
	Role          GroupRole              `protobuf:"varint,3,opt,name=role,proto3,enum=types.GroupRole" json:"role,omitempty"`       // 群角色
	...
	IsDisturb     bool                   `protobuf:"varint,7,opt,name=is_disturb,json=isDisturb,proto3" json:"is_disturb,omitempty"` // 是否免打扰
...
func (x *GroupMember) GetIsTop() bool {
	if x != nil {
		return x.IsTop
	}
	return false
...
func (x *GroupMember) GetIsDisturb() bool {
	if x != nil {
		return x.IsDisturb
	}
	return false
...
type GroupApply struct {
	...
	Status        GroupApplyStatus       `protobuf:"varint,5,opt,name=status,proto3,enum=types.GroupApplyStatus" json:"status,omitempty"`    // 申请状态 (group.proto: status)
...
type GroupNotification struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	GroupId       uint64                 `protobuf:"varint,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`                            // 群组ID
	OpType        GroupOperationType     `protobuf:"varint,2,opt,name=op_type,json=opType,proto3,enum=types.GroupOperationType" json:"op_type,omitempty"` // 操作类型
...
type Conversation struct {
	...
	Type            ConversationType       `protobuf:"varint,2,opt,name=type,proto3,enum=types.ConversationType" json:"type,omitempty"`                    // 会话类型
	TargetId        uint32                 `protobuf:"varint,3,opt,name=target_id,json=targetId,proto3" json:"target_id,omitempty"`                        // 目标ID
	LastContent     string                 `protobuf:"bytes,4,opt,name=last_content,json=lastContent,proto3" json:"last_content,omitempty"`                // 最后消息ID
...
func (x *Conversation) GetTargetId() uint32 {
	if x != nil {
		return x.TargetId
	}
	return 0
...
type SystemNotification struct {
	...
	Type           NotificationType       `protobuf:"varint,2,opt,name=type,proto3,enum=types.NotificationType" json:"type,omitempty"`                                              // 通知类型
...
func (x *SystemNotification) Reset() {
	*x = SystemNotification{}
	mi := &file_type_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SystemNotification) Descriptor() ([]byte, []int) {
	return file_type_proto_rawDescGZIP(), []int{21}
}
...
type Friend struct {
	...
	Source        int32                  `protobuf:"varint,6,opt,name=source,proto3" json:"source,omitempty"`                           // 来源
...
func (x *Friend) Reset() {
	*x = Friend{}
	mi := &file_type_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Friend) Descriptor() ([]byte, []int) {
	return file_type_proto_rawDescGZIP(), []int{22}
}
...
func (x *Friend) GetIsDisturb() bool {
	if x != nil {
		return x.IsDisturb
	}
	return false
...
type FriendRequest struct {
	...
	Status        ApplyStatus            `protobuf:"varint,5,opt,name=status,proto3,enum=types.ApplyStatus" json:"status,omitempty"`         // 申请状态 (user.proto: status int32)
	Source        ApplySource            `protobuf:"varint,6,opt,name=source,proto3,enum=types.ApplySource" json:"source,omitempty"`         // 来源 (user.proto: source int32)
...
func (x *FriendRequest) Reset() {
	*x = FriendRequest{}
	mi := &file_type_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FriendRequest) Descriptor() ([]byte, []int) {
	return file_type_proto_rawDescGZIP(), []int{23}
}
...
type UserInfo struct {
	...
	Gender            Gender                 `protobuf:"varint,4,opt,name=gender,proto3,enum=types.Gender" json:"gender,omitempty"`                             // 性别
	Phone             string                 `protobuf:"bytes,5,opt,name=phone,proto3" json:"phone,omitempty"`                                                  // 手机号
	JoinType          JoinType               `protobuf:"varint,6,opt,name=join_type,json=joinType,proto3,enum=types.JoinType" json:"join_type,omitempty"`       // 加入类型
	Status            UserStatus             `protobuf:"varint,7,opt,name=status,proto3,enum=types.UserStatus" json:"status,omitempty"`                         // 状态
...
func (x *UserInfo) Reset() {
	*x = UserInfo{}
	mi := &file_type_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserInfo) Descriptor() ([]byte, []int) {
	return file_type_proto_rawDescGZIP(), []int{24}
}
...
func (x *ErrorMessage) Reset() {
	*x = ErrorMessage{}
	mi := &file_type_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ErrorMessage) Descriptor() ([]byte, []int) {
	return file_type_proto_rawDescGZIP(), []int{25}
}
...
const file_type_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"type.proto\x12\x05types\"\x85\x01\n" +
	"\tWSMessage\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x03R\ttimestamp\x12&\n" +
	"\x04type\x18\x02 \x01(\x0e2\x12.types.MessageTypeR\x04type\x12\x18\n" +
	"\apayload\x18\x03 \x01(\fR\apayload\x12\x18\n" +
	"\aversion\x18\x04 \x01(\x05R\aversion\"\xef\x01\n" +
	"\x0fInternalMessage\x12$\n" +
	"\x0etarget_user_id\x18\x01 \x01(\x04R\ftargetUserId\x12*\n" +
	"\amessage\x18\x02 \x01(\v2\x10.types.WSMessageR\amessage\x12J\n" +
	"\finternal_ext\x18\x03 \x03(\v2'.types.InternalMessage.InternalExtEntryR\vinternalExt\x1a>\n" +
	...
	"fromUserId\x12\x1c\n" +
	"\n" +
	"to_user_id\x18\x05 \x01(\x04R\btoUserId\x12\x19\n" +
	...
	"\x06status\x18\t \x01(\x0e2\x14.types.MessageStatusR\x06status\x12-\n" +
	"\x03ext\x18\n" +
	" \x03(\v2\x1b.types.BaseMessage.ExtEntryR\x03ext\x1a6\n" +
	"\bExtEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"w\n" +
	"\vTextMessage\x12&\n" +
	"\x04base\x18\x01 \x01(\v2\x12.types.BaseMessageR\x04base\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12&\n" +
	"\aat_list\x18\x03 \x03(\v2\r.types.AtInfoR\x06atList\"n\n" +
	"\x06AtInfo\x12\x17\n" +
	...
	"\x06length\x18\x04 \x01(\x05R\x06length\"\xc7\x01\n" +
	"\fImageMessage\x12&\n" +
	"\x04base\x18\x01 \x01(\v2\x12.types.BaseMessageR\x04base\x12\x10\n" +
	...
	"\x06format\x18\a \x01(\tR\x06format\"\xe3\x01\n" +
	"\fVideoMessage\x12&\n" +
	"\x04base\x18\x01 \x01(\v2\x12.types.BaseMessageR\x04base\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12#\n" +
	...
	"\x06format\x18\b \x01(\tR\x06format\"\xa9\x01\n" +
	"\fAudioMessage\x12&\n" +
	"\x04base\x18\x01 \x01(\v2\x12.types.BaseMessageR\x04base\x12\x10\n" +
	...
	"\ais_read\x18\x06 \x01(\bR\x06isRead\"\xa7\x01\n" +
	"\vFileMessage\x12&\n" +
	"\x04base\x18\x01 \x01(\v2\x12.types.BaseMessageR\x04base\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12\x1b\n" +
	"\tfile_name\x18\x03 \x01(\tR\bfileName\x12\x12\n" +
	"\x04size\x18\x04 \x01(\x03R\x04size\x12\x1b\n" +
	"\tfile_type\x18\x05 \x01(\tR\bfileType\x12\x10\n" +
	"\x03md5\x18\x06 \x01(\tR\x03md5\"\xa3\x01\n" +
	"\x0fLocationMessage\x12&\n" +
	"\x04base\x18\x01 \x01(\v2\x12.types.BaseMessageR\x04base\x12\x1a\n" +
	"\blatitude\x18\x02 \x01(\x01R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x03 \x01(\x01R\tlongitude\x12\x18\n" +
	"\aaddress\x18\x04 \x01(\tR\aaddress\x12\x14\n" +
	"\x05title\x18\x05 \x01(\tR\x05title\"l\n" +
	"\rCustomMessage\x12&\n" +
	"\x04base\x18\x01 \x01(\v2\x12.types.BaseMessageR\x04base\x12\x1f\n" +
	"\vcustom_type\x18\x02 \x01(\tR\n" +
	"customType\x12\x12\n" +
	"\x04data\x18\x03 \x01(\tR\x04data\"\xa6\x01\n" +
	"\n" +
	"MessageAck\x12\x15\n" +
	"\x06msg_id\x18\x01 \x01(\tR\x05msgId\x12\x1b\n" +
	"\tclient_id\x18\x02 \x01(\tR\bclientId\x12\x1d\n" +
	"\n" +
	"session_id\x18\x03 \x01(\tR\tsessionId\x12(\n" +
	"\x06status\x18\x04 \x01(\x0e2\x10.types.AckStatusR\x06status\x12\x1b\n" +
	"\terror_msg\x18\x05 \x01(\tR\berrorMsg\"\x85\x01\n" +
	...
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12+\n" +
	"\x06status\x18\x02 \x01(\x0e2\x13.types.OnlineStatusR\x06status\x12(\n" +
	...
	"\auser_id\x18\x02 \x01(\x04R\x06userId\x12$\n" +
	"\x04role\x18\x03 \x01(\x0e2\x10.types.GroupRoleR\x04role\x12\x1a\n" +
	"\bnickname\x18\x04 \x01(\tR\bnickname\x12\x1d\n" +
	"\n" +
	"mute_until\x18\x05 \x01(\x03R\tmuteUntil\x12\x15\n" +
	"\x06is_top\x18\x06 \x01(\bR\x05isTop\x12\x1d\n" +
	"\n" +
	"is_disturb\x18\a \x01(\bR\tisDisturb\x12\x1b\n" +
	"\tjoined_at\x18\b \x01(\x03R\bjoinedAt\x12\x14\n" +
	"\x05extra\x18\t \x01(\tR\x05extra\"\xaa\x02\n" +
	"\n" +
	"GroupApply\x12\x0e\n" +
	...
	"\x06status\x18\x05 \x01(\x0e2\x17.types.GroupApplyStatusR\x06status\x12\x1d\n" +
	"\n" +
	"handler_id\x18\x06 \x01(\x04R\thandlerId\x12!\n" +
	"\frequest_time\x18\a \x01(\x03R\vrequestTime\x12\x1f\n" +
	"\vhandle_time\x18\b \x01(\x03R\n" +
	"handleTime\x12#\n" +
	"\rreject_reason\x18\t \x01(\tR\frejectReason\"\x84\x02\n" +
	"\x11GroupNotification\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\x04R\agroupId\x122\n" +
	"\aop_type\x18\x02 \x01(\x0e2\x19.types.GroupOperationTypeR\x06opType\x12\x1f\n" +
	...
	"\n" +
	"group_info\x18\a \x01(\v2\x10.types.GroupInfoR\tgroupInfo\"\xb5\x02\n" +
	"\fConversation\x12'\n" +
	"\x0fconversation_id\x18\x01 \x01(\tR\x0econversationId\x12+\n" +
	"\x04type\x18\x02 \x01(\x0e2\x17.types.ConversationTypeR\x04type\x12\x1b\n" +
	"\ttarget_id\x18\x03 \x01(\rR\btargetId\x12!\n" +
	...
	"\x04type\x18\x02 \x01(\x0e2\x17.types.NotificationTypeR\x04type\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x18\n" +
	"\acontent\x18\x04 \x01(\tR\acontent\x12\x1f\n" +
	"\vcreate_time\x18\x05 \x01(\x03R\n" +
	"createTime\x127\n" +
	"\x04data\x18\x06 \x03(\v2#.types.SystemNotification.DataEntryR\x04data\x1a7\n" +
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x06source\x18\x06 \x01(\x05R\x06source\x12\x15\n" +
	"\x06is_top\x18\a \x01(\bR\x05isTop\x12\x1d\n" +
	"\n" +
	"is_disturb\x18\b \x01(\bR\tisDisturb\x12\x1f\n" +
	"\vcreate_time\x18\t \x01(\x03R\n" +
	"createTime\x12\x14\n" +
	"\x05extra\x18\n" +
	" \x01(\tR\x05extra\"\xbd\x02\n" +
	...
	"\tapply_msg\x18\x04 \x01(\tR\bapplyMsg\x12*\n" +
	"\x06status\x18\x05 \x01(\x0e2\x12.types.ApplyStatusR\x06status\x12*\n" +
	"\x06source\x18\x06 \x01(\x0e2\x12.types.ApplySourceR\x06source\x12!\n" +
	"\frequest_time\x18\a \x01(\x03R\vrequestTime\x12\x1f\n" +
	"\vhandle_time\x18\b \x01(\x03R\n" +
	"handleTime\x12#\n" +
	"\rreject_reason\x18\t \x01(\tR\frejectReason\"\xdf\x02\n" +
	"\bUserInfo\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12\x1b\n" +
	"\tuser_name\x18\x02 \x01(\tR\buserName\x12\x16\n" +
	"\x06avatar\x18\x03 \x01(\tR\x06avatar\x12%\n" +
	"\x06gender\x18\x04 \x01(\x0e2\r.types.GenderR\x06gender\x12\x14\n" +
	"\x05phone\x18\x05 \x01(\tR\x05phone\x12,\n" +
	"\tjoin_type\x18\x06 \x01(\x0e2\x0f.types.JoinTypeR\bjoinType\x12)\n" +
	"\x06status\x18\a \x01(\x0e2\x11.types.UserStatusR\x06status\x12-\n" +
	...
	"\adetails\x18\x05 \x03(\v2 .types.ErrorMessage.DetailsEntryR\adetails\x1a:\n" +
	...
	"\x1aNOTIFICATION_TYPE_SECURITY\x10\x03*\x93\x01\n" +
...
var file_type_proto_enumTypes = make([]protoimpl.EnumInfo, 15)
var file_type_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_type_proto_goTypes = []any{
	(MessageType)(0),           // 0: types.MessageType
	(MessageStatus)(0),         // 1: types.MessageStatus
	(AckStatus)(0),             // 2: types.AckStatus
	(OnlineStatus)(0),          // 3: types.OnlineStatus
	(GroupRole)(0),             // 4: types.GroupRole
	(GroupApplyStatus)(0),      // 5: types.GroupApplyStatus
	(GroupOperationType)(0),    // 6: types.GroupOperationType
	(ConversationType)(0),      // 7: types.ConversationType
	(NotificationType)(0),      // 8: types.NotificationType
	(ApplyStatus)(0),           // 9: types.ApplyStatus
	(ApplySource)(0),           // 10: types.ApplySource
	(Gender)(0),                // 11: types.Gender
	(JoinType)(0),              // 12: types.JoinType
	(UserStatus)(0),            // 13: types.UserStatus
	(ErrorCode)(0),             // 14: types.ErrorCode
	(*WSMessage)(nil),          // 15: types.WSMessage
	(*InternalMessage)(nil),    // 16: types.InternalMessage
	(*BaseMessage)(nil),        // 17: types.BaseMessage
	(*TextMessage)(nil),        // 18: types.TextMessage
	(*AtInfo)(nil),             // 19: types.AtInfo
	(*ImageMessage)(nil),       // 20: types.ImageMessage
	(*VideoMessage)(nil),       // 21: types.VideoMessage
	(*AudioMessage)(nil),       // 22: types.AudioMessage
	(*FileMessage)(nil),        // 23: types.FileMessage
	(*LocationMessage)(nil),    // 24: types.LocationMessage
	(*CustomMessage)(nil),      // 25: types.CustomMessage
	(*MessageAck)(nil),         // 26: types.MessageAck
	(*MessageRead)(nil),        // 27: types.MessageRead
	(*MessageRecall)(nil),      // 28: types.MessageRecall
	(*UserOnlineStatus)(nil),   // 29: types.UserOnlineStatus
	(*TypingStatus)(nil),       // 30: types.TypingStatus
	(*GroupInfo)(nil),          // 31: types.GroupInfo
	(*GroupMember)(nil),        // 32: types.GroupMember
	(*GroupApply)(nil),         // 33: types.GroupApply
	(*GroupNotification)(nil),  // 34: types.GroupNotification
	(*Conversation)(nil),       // 35: types.Conversation
	(*SystemNotification)(nil), // 36: types.SystemNotification
	(*Friend)(nil),             // 37: types.Friend
	(*FriendRequest)(nil),      // 38: types.FriendRequest
	(*UserInfo)(nil),           // 39: types.UserInfo
	(*ErrorMessage)(nil),       // 40: types.ErrorMessage
	nil,                        // 41: types.InternalMessage.InternalExtEntry
	nil,                        // 42: types.BaseMessage.ExtEntry
	nil,                        // 43: types.SystemNotification.DataEntry
	nil,                        // 44: types.ErrorMessage.DetailsEntry
}
var file_type_proto_depIdxs = []int32{
	0,  // 0: types.WSMessage.type:type_name -> types.MessageType
	15, // 1: types.InternalMessage.message:type_name -> types.WSMessage
	41, // 2: types.InternalMessage.internal_ext:type_name -> types.InternalMessage.InternalExtEntry
	1,  // 3: types.BaseMessage.status:type_name -> types.MessageStatus
	42, // 4: types.BaseMessage.ext:type_name -> types.BaseMessage.ExtEntry
	17, // 5: types.TextMessage.base:type_name -> types.BaseMessage
	19, // 6: types.TextMessage.at_list:type_name -> types.AtInfo
	17, // 7: types.ImageMessage.base:type_name -> types.BaseMessage
	17, // 8: types.VideoMessage.base:type_name -> types.BaseMessage
	17, // 9: types.AudioMessage.base:type_name -> types.BaseMessage
	17, // 10: types.FileMessage.base:type_name -> types.BaseMessage
	17, // 11: types.LocationMessage.base:type_name -> types.BaseMessage
	17, // 12: types.CustomMessage.base:type_name -> types.BaseMessage
	2,  // 13: types.MessageAck.status:type_name -> types.AckStatus
	3,  // 14: types.UserOnlineStatus.status:type_name -> types.OnlineStatus
	4,  // 15: types.GroupMember.role:type_name -> types.GroupRole
	5,  // 16: types.GroupApply.status:type_name -> types.GroupApplyStatus
	6,  // 17: types.GroupNotification.op_type:type_name -> types.GroupOperationType
	31, // 18: types.GroupNotification.group_info:type_name -> types.GroupInfo
	7,  // 19: types.Conversation.type:type_name -> types.ConversationType
	8,  // 20: types.SystemNotification.type:type_name -> types.NotificationType
	43, // 21: types.SystemNotification.data:type_name -> types.SystemNotification.DataEntry
	9,  // 22: types.FriendRequest.status:type_name -> types.ApplyStatus
	10, // 23: types.FriendRequest.source:type_name -> types.ApplySource
	11, // 24: types.UserInfo.gender:type_name -> types.Gender
	12, // 25: types.UserInfo.join_type:type_name -> types.JoinType
	13, // 26: types.UserInfo.status:type_name -> types.UserStatus
	44, // 27: types.ErrorMessage.details:type_name -> types.ErrorMessage.DetailsEntry
