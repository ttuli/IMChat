...
const file_internal_apps_Group_api_types_group_api_proto_rawDesc = "" +
	"\n" +
	"-internal/apps/Group/api/types/group_api.proto\x12\vtypes.group\"\xc3\x01\n" +
	...
	"\n" +
	"failed_ids\x18\x02 \x03(\x04R\tfailedIds\"\xef\x01\n" +
	...
	"\n" +
	"invitee_id\x18\x04 \x01(\x04R\tinviteeId\x12\x16\n" +
	"\x06status\x18\x05 \x01(\x05R\x06status\x12\x1d\n" +
	"\n" +
	...
	"\tinvite_id\x18\x01 \x01(\x04R\binviteId\x12\x16\n" +
	"\x06accept\x18\x02 \x01(\bR\x06accept\"I\n" +
	"\x15HandleGroupInviteResp\x120\n" +
	"\x06member\x18\x01 \x01(\v2\x18.types.group.GroupMemberR\x06member\"\x16\n" +
	"\x14GetPendingInvitesReq\"E\n" +
	"\x15GetPendingInvitesResp\x12,\n" +
	"\x04data\x18\x01 \x03(\v2\x18.types.group.GroupInviteR\x04data\"\x81\x01\n" +
	"\x0fRemoveMemberReq\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\x04R\agroupId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x04R\x06userId\x12\x1f\n" +
	"\voperator_id\x18\x03 \x01(\x04R\n" +
	"operatorId\x12\x19\n" +
	"\buser_ids\x18\x04 \x03(\x04R\auserIds\"*\n" +
