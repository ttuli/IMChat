...
const file_rpc_group_proto_rawDesc = "" +
	...
	"\x04role\x18\x03 \x01(\x0e2\x10.group.GroupRoleR\x04role\x12\x1a\n" +
	...
	"\x04data\x18\x01 \x03(\x04R\x04data\"m\n" +
	"\x10InviteMembersReq\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\x04R\agroupId\x12\x1f\n" +
	"\voperator_id\x18\x02 \x01(\x04R\n" +
	"operatorId\x12\x1d\n" +
	"\n" +
	"member_ids\x18\x03 \x03(\x04R\tmemberIds\"W\n" +
	...
	"\voperator_id\x18\x02 \x01(\x04R\n" +
	"operatorId\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\x04R\x06userId\"C\n" +
	"\rLeaveGroupReq\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\x04R\agroupId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x04R\x06userId\"\x8d\x01\n" +
	"\x10SetMemberRoleReq\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\x04R\agroupId\x12\x1f\n" +
	"\voperator_id\x18\x02 \x01(\x04R\n" +
	"operatorId\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\x04R\x06userId\x12$\n" +
	"\x04role\x18\x04 \x01(\x0e2\x10.group.GroupRoleR\x04role\"f\n" +
	"\x14SetMemberNicknameReq\x12\x19\n" +
	"\bgroup_id\x18\x01 \x01(\x04R\agroupId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x04R\x06userId\x12\x1a\n" +
	"\bnickname\x18\x03 \x01(\tR\bnickname\"\x83\x01\n" +
	...
	"\n" +
	"mute_until\x18\x04 \x01(\x03R\tmuteUntil\"1\n" +
	...
	"\x04data\x18\x01 \x03(\v2\x13.group.GroupRequestR\x04data*\x95\x01\n" +
	"\vApplyStatus\x12\x1c\n" +
	"\x18APPLY_STATUS_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14APPLY_STATUS_PENDING\x10\x01\x12\x19\n" +
	"\x15APPLY_STATUS_ACCEPTED\x10\x02\x12\x19\n" +
	"\x15APPLY_STATUS_REJECTED\x10\x03\x12\x18\n" +
	"\x14APPLY_STATUS_IGNORED\x10\x04*j\n" +
	"\tGroupRole\x12\x1a\n" +
	...
	"\vUpdateGroup\x12\x15.group.UpdateGroupReq\x1a\x10.group.EmptyResp\x128\n" +
	"\fDismissGroup\x12\x16.group.DismissGroupReq\x1a\x10.group.EmptyResp\x12B\n" +
	"\rGetUserGroups\x12\x17.group.GetUserGroupsReq\x1a\x18.group.GetUserGroupsResp\x12B\n" +
	"\rInviteMembers\x12\x17.group.InviteMembersReq\x1a\x18.group.InviteMembersResp\x128\n" +
	"\fRemoveMember\x12\x16.group.RemoveMemberReq\x1a\x10.group.EmptyResp\x124\n" +
	"\n" +
	"LeaveGroup\x12\x14.group.LeaveGroupReq\x1a\x10.group.EmptyResp\x12:\n" +
	"\rSetMemberRole\x12\x17.group.SetMemberRoleReq\x1a\x10.group.EmptyResp\x12B\n" +
...
var file_rpc_group_proto_goTypes = []any{
	...
	(*EmptyResp)(nil),             // 2: group.EmptyResp
	(*Group)(nil),                 // 3: group.Group
	(*GroupMember)(nil),           // 4: group.GroupMember
	(*GroupRequest)(nil),          // 5: group.GroupRequest
	(*CreateGroupReq)(nil),        // 6: group.CreateGroupReq
	(*CreateGroupResp)(nil),       // 7: group.CreateGroupResp
	(*GetGroupReq)(nil),           // 8: group.GetGroupReq
	(*GetGroupResp)(nil),          // 9: group.GetGroupResp
	(*UpdateGroupReq)(nil),        // 10: group.UpdateGroupReq
	(*DismissGroupReq)(nil),       // 11: group.DismissGroupReq
	(*GetUserGroupsReq)(nil),      // 12: group.GetUserGroupsReq
	(*GetUserGroupsResp)(nil),     // 13: group.GetUserGroupsResp
	(*InviteMembersReq)(nil),      // 14: group.InviteMembersReq
	(*InviteMembersResp)(nil),     // 15: group.InviteMembersResp
	(*RemoveMemberReq)(nil),       // 16: group.RemoveMemberReq
	(*LeaveGroupReq)(nil),         // 17: group.LeaveGroupReq
	(*SetMemberRoleReq)(nil),      // 18: group.SetMemberRoleReq
	(*SetMemberNicknameReq)(nil),  // 19: group.SetMemberNicknameReq
...
var file_rpc_group_proto_depIdxs = []int32{
	...
	3,  // 2: group.CreateGroupResp.data:type_name -> group.Group
