...
const file_rpc_user_proto_rawDesc = "" +
	...
	"\x04data\x18\x01 \x03(\v2\f.user.FriendR\x04data\"\x93\x01\n" +
	...
	"\x04data\x18\x01 \x03(\v2\x13.user.FriendRequestR\x04data2\x97\x05\n" +
	"\x04User\x127\n" +
	"\n" +
...
var file_rpc_user_proto_goTypes = []any{
	...
	(*UpdateFriendReq)(nil),             // 13: user.UpdateFriendReq
	(*UpdateFriendResp)(nil),            // 14: user.UpdateFriendResp
	(*DeleteFriendReq)(nil),             // 15: user.DeleteFriendReq
...
var file_rpc_user_proto_depIdxs = []int32{
	...
	9,  // 2: user.UpdateFriendResp.data:type_name -> user.Friend
	...
	13, // 12: user.User.UpdateFriend:input_type -> user.UpdateFriendReq
	15, // 13: user.User.DeleteFriend:input_type -> user.DeleteFriendReq
	16, // 14: user.User.NewFriendApply:input_type -> user.NewFriendApplyReq
	18, // 15: user.User.HandleFriendApply:input_type -> user.HandleFriendApplyReq
	20, // 16: user.User.GetPendingFriendApplies:input_type -> user.GetPendingFriendAppliesReq
	3,  // 17: user.User.CreateUser:output_type -> user.CreateUserResp
	5,  // 18: user.User.GetUserInfo:output_type -> user.GetUserInfoResp
	0,  // 19: user.User.UpdateInfo:output_type -> user.EmptyResp
	8,  // 20: user.User.VerifyPassword:output_type -> user.VerifyPasswordResp
	12, // 21: user.User.GetFriends:output_type -> user.GetFriendsResp
	14, // 22: user.User.UpdateFriend:output_type -> user.UpdateFriendResp
